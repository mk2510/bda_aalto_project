...
### Seperated model
We will now also show, how close our modeling is, when compared to the original data. We choose for this a visual approach.
```{r}
finland_mu <- c()
for(i in 3001:4000){
    finland_mu <- c(finland_mu, fit_sm$mu[i,1,])
}
...
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
    ggtitle("Modelled means and accual data for Finland") +
    xlab("time") + ylab("vaccination rate")
```
```{r}
Y_s = c(fit_sm$mu[3000:4000,2,],germany$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), germany$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
    ggtitle("Modelled means and accual data for Finland") +
    xlab("time") + ylab("vaccination rate")
```
```{r}
Y_s = c(fit_sm$mu[3000,3,],hongkong$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), hongkong$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
    ggtitle("Modelled means and accual data for Finland") +
...
```
```{r}
Y_s = c(fit_sm$mu[3000,4,],portugal$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), portugal$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
    ggtitle("Modelled means and accual data for Finland") +
...
```
```{r}
Y_s = c(fit_sm$mu[3000,1,],japan$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), japan$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
    ggtitle("Modelled means and accual data for Finland") +
...
### Hirachical Model
```{r}
Y_s = c(fit_hm$mu[3000,1,],finland$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), finland$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
    ggtitle("Modelled means and accual data for Finland") +
...
```
```{r}
Y_s = c(fit_hm$mu[3000,2,],germany$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), germany$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
...
```
```{r}
Y_s = c(fit_hm$mu[3000,3,],hongkong$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), hongkong$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
...
```
```{r}
Y_s = c(fit_hm$mu[3000,4,],portugal$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), portugal$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
...
```
```{r}
Y_s = c(fit_hm$mu[3000,1,],japan$Y)
names = c(rep(c("Model"), times = 222, length.out = NA, each = 1), japan$Country)
result_s = data.frame(Country=names,X=total$X[1:444],Y=Y_s)
ggplot(data = result_s, aes(x =X, y = Y, color = Country)) +
    geom_line() +
