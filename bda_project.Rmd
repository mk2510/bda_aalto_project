...
for(p in sigma_priors) {
  ...
  model_separated_parameterized <- rstan::sampling(smp, data = stan_data_parameterized, warmup=3000, iter=4000)
  fit_smp <- extract(model_separated_parameterized, permuted = TRUE, inc_warmup = FALSE)
...
ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different alpha priors for Finland") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different alpha priors for Germany") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different alpha priors for Portugal") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different alpha priors for Hong Kong") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different alpha priors for Japan") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
values <- c(fit_smps[1,]$beta[,1],
            ...
            fit_smps[4,]$beta[,1],
            fit_smps[5,]$beta[,1])
group <- c(rep(sprintf("%f : %f", beta_priors[1,1], beta_priors[1,2]), length(fit_smps[1,]$beta[,1])),
           rep(sprintf("%f : %f", beta_priors[2,1], beta_priors[2,2]), length(fit_smps[2,]$beta[,1])),
           rep(sprintf("%f : %f", beta_priors[3,1], beta_priors[3,2]), length(fit_smps[3,]$beta[,1])),
           rep(sprintf("%f : %f", beta_priors[4,1], beta_priors[4,2]), length(fit_smps[4,]$beta[,1])),
           rep(sprintf("%f : %f", beta_priors[5,1], beta_priors[5,2]), length(fit_smps[5,]$beta[,1])))
data <- data.frame(values = values, group = group)

ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different beta priors for Finland") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
values <- c(fit_smps[1,]$beta[,2],
            ...
            fit_smps[4,]$beta[,2],
            fit_smps[5,]$beta[,2])
group <- c(rep(sprintf("%f : %f", beta_priors[1,1], beta_priors[1,2]), length(fit_smps[1,]$beta[,2])),
           rep(sprintf("%f : %f", beta_priors[2,1], beta_priors[2,2]), length(fit_smps[2,]$beta[,2])),
           rep(sprintf("%f : %f", beta_priors[3,1], beta_priors[3,2]), length(fit_smps[3,]$beta[,2])),
           rep(sprintf("%f : %f", beta_priors[4,1], beta_priors[4,2]), length(fit_smps[4,]$beta[,2])),
           rep(sprintf("%f : %f", beta_priors[5,1], beta_priors[5,2]), length(fit_smps[5,]$beta[,2])))
data <- data.frame(values = values, group = group)

ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different beta priors for Germany") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
values <- c(fit_smps[1,]$beta[,3],
            ...
            fit_smps[4,]$beta[,3],
            fit_smps[5,]$beta[,3])
group <- c(rep(sprintf("%f : %f", beta_priors[1,1], beta_priors[1,2]), length(fit_smps[1,]$beta[,3])),
           rep(sprintf("%f : %f", beta_priors[2,1], beta_priors[2,2]), length(fit_smps[2,]$beta[,3])),
           rep(sprintf("%f : %f", beta_priors[3,1], beta_priors[3,2]), length(fit_smps[3,]$beta[,3])),
           rep(sprintf("%f : %f", beta_priors[4,1], beta_priors[4,2]), length(fit_smps[4,]$beta[,3])),
           rep(sprintf("%f : %f", beta_priors[5,1], beta_priors[5,2]), length(fit_smps[5,]$beta[,3])))
data <- data.frame(values = values, group = group)

ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different beta priors for Portugal") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
values <- c(fit_smps[1,]$beta[,4],
            ...
            fit_smps[4,]$beta[,4],
            fit_smps[5,]$beta[,4])
group <- c(rep(sprintf("%f : %f", beta_priors[1,1], beta_priors[1,2]), length(fit_smps[1,]$beta[,4])),
           rep(sprintf("%f : %f", beta_priors[2,1], beta_priors[2,2]), length(fit_smps[2,]$beta[,4])),
           rep(sprintf("%f : %f", beta_priors[3,1], beta_priors[3,2]), length(fit_smps[3,]$beta[,4])),
           rep(sprintf("%f : %f", beta_priors[4,1], beta_priors[4,2]), length(fit_smps[4,]$beta[,4])),
           rep(sprintf("%f : %f", beta_priors[5,1], beta_priors[5,2]), length(fit_smps[5,]$beta[,4])))
data <- data.frame(values = values, group = group)

ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different beta priors for Hong Kong") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
values <- c(fit_smps[1,]$beta[,5],
            ...
            fit_smps[4,]$beta[,5],
            fit_smps[5,]$beta[,5])
group <- c(rep(sprintf("%f : %f", beta_priors[1,1], beta_priors[1,2]), length(fit_smps[1,]$beta[,5])),
           rep(sprintf("%f : %f", beta_priors[2,1], beta_priors[2,2]), length(fit_smps[2,]$beta[,5])),
           rep(sprintf("%f : %f", beta_priors[3,1], beta_priors[3,2]), length(fit_smps[3,]$beta[,5])),
           rep(sprintf("%f : %f", beta_priors[4,1], beta_priors[4,2]), length(fit_smps[4,]$beta[,5])),
           rep(sprintf("%f : %f", beta_priors[5,1], beta_priors[5,2]), length(fit_smps[5,]$beta[,5])))
data <- data.frame(values = values, group = group)

ggplot(data, aes(x = values, fill = group)) + ggtitle("Plot of different beta priors for Japan") +
  geom_histogram(position = "identity", alpha = 0.2, bins = 50)
```
...
for(p in sigma_priors) {
  ...
  model_hierarchical_parameterized <- rstan::sampling(hmp, data = stan_data_parameterized, warmup=3000, iter=4000)
  fit_hmp <- extract(model_hierarchical_parameterized, permuted = TRUE, inc_warmup = FALSE)
...
values <- c(fit_hmps[1,]$beta[,1],
            ...
            fit_hmps[4,]$beta[,1],
            fit_hmps[5,]$beta[,1])
group <- c(rep(sprintf("%f : %f : %f", beta_priors[1,1], beta_priors[1,2], beta_priors[1,3]), length(fit_hmps[1,]$beta[,1])),
           rep(sprintf("%f : %f : %f", beta_priors[2,1], beta_priors[2,2], beta_priors[2,3]), length(fit_hmps[2,]$beta[,1])),
           rep(sprintf("%f : %f : %f", beta_priors[3,1], beta_priors[3,2], beta_priors[3,3]), length(fit_hmps[3,]$beta[,1])),
           rep(sprintf("%f : %f : %f", beta_priors[4,1], beta_priors[4,2], beta_priors[4,3]), length(fit_hmps[4,]$beta[,1])),
           rep(sprintf("%f : %f : %f", beta_priors[5,1], beta_priors[5,2], beta_priors[5,3]), length(fit_hmps[5,]$beta[,1])))
data <- data.frame(values = values, group = group)
...
values <- c(fit_hmps[1,]$beta[,2],
            ...
            fit_hmps[4,]$beta[,2],
            fit_hmps[5,]$beta[,2])
group <- c(rep(sprintf("%f : %f : %f", beta_priors[1,1], beta_priors[1,2], beta_priors[1,3]), length(fit_hmps[1,]$beta[,2])),
           rep(sprintf("%f : %f : %f", beta_priors[2,1], beta_priors[2,2], beta_priors[2,3]), length(fit_hmps[2,]$beta[,2])),
           rep(sprintf("%f : %f : %f", beta_priors[3,1], beta_priors[3,2], beta_priors[3,3]), length(fit_hmps[3,]$beta[,2])),
           rep(sprintf("%f : %f : %f", beta_priors[4,1], beta_priors[4,2], beta_priors[4,3]), length(fit_hmps[4,]$beta[,2])),
           rep(sprintf("%f : %f : %f", beta_priors[5,1], beta_priors[5,2], beta_priors[5,3]), length(fit_hmps[5,]$beta[,2])))
data <- data.frame(values = values, group = group)
...
values <- c(fit_hmps[1,]$beta[,3],
            ...
            fit_hmps[4,]$beta[,3],
            fit_hmps[5,]$beta[,3])
group <- c(rep(sprintf("%f : %f : %f", beta_priors[1,1], beta_priors[1,2], beta_priors[1,3]), length(fit_hmps[1,]$beta[,3])),
           rep(sprintf("%f : %f : %f", beta_priors[2,1], beta_priors[2,2], beta_priors[2,3]), length(fit_hmps[2,]$beta[,3])),
           rep(sprintf("%f : %f : %f", beta_priors[3,1], beta_priors[3,2], beta_priors[3,3]), length(fit_hmps[3,]$beta[,3])),
           rep(sprintf("%f : %f : %f", beta_priors[4,1], beta_priors[4,2], beta_priors[4,3]), length(fit_hmps[4,]$beta[,3])),
           rep(sprintf("%f : %f : %f", beta_priors[5,1], beta_priors[5,2], beta_priors[5,3]), length(fit_hmps[5,]$beta[,3])))
data <- data.frame(values = values, group = group)
...
values <- c(fit_hmps[1,]$beta[,4],
            ...
            fit_hmps[4,]$beta[,4],
            fit_hmps[5,]$beta[,4])
group <- c(rep(sprintf("%f : %f : %f", beta_priors[1,1], beta_priors[1,2], beta_priors[1,3]), length(fit_hmps[1,]$beta[,4])),
           rep(sprintf("%f : %f : %f", beta_priors[2,1], beta_priors[2,2], beta_priors[2,3]), length(fit_hmps[2,]$beta[,4])),
           rep(sprintf("%f : %f : %f", beta_priors[3,1], beta_priors[3,2], beta_priors[3,3]), length(fit_hmps[3,]$beta[,4])),
           rep(sprintf("%f : %f : %f", beta_priors[4,1], beta_priors[4,2], beta_priors[4,3]), length(fit_hmps[4,]$beta[,4])),
           rep(sprintf("%f : %f : %f", beta_priors[5,1], beta_priors[5,2], beta_priors[5,3]), length(fit_hmps[5,]$beta[,4])))
data <- data.frame(values = values, group = group)
...
values <- c(fit_hmps[1,]$beta[,5],
            ...
            fit_hmps[4,]$beta[,5],
            fit_hmps[5,]$beta[,5])
group <- c(rep(sprintf("%f : %f : %f", beta_priors[1,1], beta_priors[1,2], beta_priors[1,3]), length(fit_hmps[1,]$beta[,5])),
           rep(sprintf("%f : %f : %f", beta_priors[2,1], beta_priors[2,2], beta_priors[2,3]), length(fit_hmps[2,]$beta[,5])),
           rep(sprintf("%f : %f : %f", beta_priors[3,1], beta_priors[3,2], beta_priors[3,3]), length(fit_hmps[3,]$beta[,5])),
           rep(sprintf("%f : %f : %f", beta_priors[4,1], beta_priors[4,2], beta_priors[4,3]), length(fit_hmps[4,]$beta[,5])),
           rep(sprintf("%f : %f : %f", beta_priors[5,1], beta_priors[5,2], beta_priors[5,3]), length(fit_hmps[5,]$beta[,5])))
data <- data.frame(values = values, group = group)
